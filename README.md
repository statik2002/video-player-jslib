...
![my_example](screenshots/my_screenshot.png)
...
- Страница со средними настройками и стилями - [index.html](./index.html)

Пример работы плеера на сайте:

- [Ссылка](https://statik2002.github.io/video-player-jslib/)
